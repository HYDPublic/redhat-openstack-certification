...
# make sure we have openstack-nova-migration package
# See BZ https://bugzilla.redhat.com/show_bug.cgi?id=1446825
# Need this for minor update with BZ 1428241
if hiera service_names | grep nova_compute; then
   echo "Installing openstack-nova-migration"
   yum -y install openstack-nova-migration
fi
